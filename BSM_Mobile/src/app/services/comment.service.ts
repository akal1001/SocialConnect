...
export class CommentService {
  ...
  GetCommentsService(contentReferanceId: string): Observable<IComment[]> {
    return this._httpClient.get<IComment[]>(
      this._Url + "getComments?contentId=" + contentReferanceId
    );
  }
  //post comment
  PostCommentService(
    ...
    const commentEndoint =
      this._Url +
      "leaveComment?postedId=" +
      psoteId +
      "&commenterId=" +
      commenterId +
      "&yourComment=" +
  ...
  PostReplayForCommentServce(
    replayerId: string,
    commentId: string,
    replayText: string
  ): Observable<any> {
    console.log(commentId + "\n" + replayText + "\n" + replayerId);
    // alert(commentId + " :::::: " + replayText + " :::" + replayerId)
    const endpoint =
      this._Url +
      "postReplay?replayerId=" +
      replayerId +
      "&commentId=" +
      commentId +
      "&replayText=" +
